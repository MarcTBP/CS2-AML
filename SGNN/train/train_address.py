...
def train_epoch(epoch, batch_train_times, batch_inference_times):
    ...
    # This was added to replace the cuda GPU dependt code. Start ###################################################
        start_train = time.time()

    # This was altered because GPU is not cuda enabled.
    ...
    # This was added to replace the cuda GPU dependt code.
        end_train = time.time()
